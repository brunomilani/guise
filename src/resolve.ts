 ...
 */
export function autoResolveAccount(
 ...
 */
export function isSupported(p: Provider): boolean {
 ...
 */
export function hasAccountCli(p: Provider): boolean {
  return p === "github";
}
 ...
 */
export function usesSshModel(p: Provider): boolean {
